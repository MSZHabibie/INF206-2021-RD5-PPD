	...
	<div id="app">
		<div class="main-wrapper">
									...
									<div class="card-body">
										<div class="table-responsive">
											...
											<table class="table table-striped">
												...
												<tr>
													<td>1</td>
													<td>Yovie Pramudya Sabri</td>
													<td>12-12-2020</td>
													<td>
														<div class="badge badge-success">Active</div>
													</td>
													<td><a href="#" class="btn btn-action btn-secondary">Member</a></td>                                               
												</tr>
												<tr>
													<td>2</td>
													<td>Fazil Basri</td>
													...
													<td><a href="#" class="btn btn-action btn-secondary">Not Member</a></td>
												</tr>
												<tr>
													<td>3</td>
													<td>Bayu Ramadhan</td>
												...
												<tr>
													<td>4</td>
													<td>Muhammad Syah Zichrullah Habibie</td>
													<td>19-12-2020</td>
													<td>
														<div class="badge badge-success">Active</div>
													</td>
                                        ...
                                        <button style="background-color:blue" href="#" class="btn btn-action btn-secondary">Tambah</button>
                                        <button style="background-color:blue" href="#" class="btn btn-action btn-secondary">Edit</button>
                                        <button style="background-color:red" href="#" class="btn btn-action btn-secondary">Hapus</button>
									</div>                                   
			...
			<footer class="main-footer">
				<div class="footer-left"> Copyright &copy; RD 5 GROUP
					<div class="bullet"></div> Design By <a href="#">RD 5</a> </div>
