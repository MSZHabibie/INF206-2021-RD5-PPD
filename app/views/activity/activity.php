...
<head>
	...
	<title>PPD</title>
	<!--favicon-->
	<link rel="icon" href="../dist/img/avatar/icones.png type="image">
			...
			<div class="main-sidebar">
				<aside id="sidebar-wrapper">
					...
					<div class="sidebar-user">
						<div class="sidebar-user-picture"> <img alt="image" src="../dist/img/avatar/avatar-5.jpeg"> </div>
					...
					<ul class="sidebar-menu">
						...
						<li class="active"> <a href="activity.html" ><i class="fas fa-american-sign-language-interpreting"></i><span>Activity</span></a></li>
        		...
        		<tr>
        			<td>
        				<div class="text-center">
        					<a href="detail1.html" class="btn btn-primary btn-round">Detail</a>
        				</div>
        			</td>
        			<td>
        				<div class="text-center">
        					<a href="detail2.html" class="btn btn-primary btn-round">Detail</a>
        				</div>
        			</td>
        			<td>
        				<div class="text-center">
        					<a href="detail3.html" class="btn btn-primary btn-round">Detail</a>
        				</div
        			</td>
        		</tr>
        	</table>
